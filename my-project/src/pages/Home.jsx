...
const Home = () => {
  ...
  const otherArticles = articlesData.slice(1, 4);
    ...
    <div>
      ...
      <section className="relative h-screen bg-slate-900 text-white flex items-center p-4 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 items-center z-10">
          ...
          >
            <ArticleCard article={latestArticle} index={0} />
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-12 text-slate-800">Latest Articles</h2>
          ...
          <div className="text-center mt-16">
            <Link to="/articles" className="text-[#00A39C] font-bold text-lg hover:underline transition-all duration-300 inline-block group">
