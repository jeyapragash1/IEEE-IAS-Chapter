      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative">
          <Swiper
            ...
            navigation={{ nextEl: '.swiper-button-next-custom-featured', prevEl: '.swiper-button-prev-custom-featured' }}
            className="!py-10"
          >
            {featuredArticles.map((article) => (
              <SwiperSlide key={article.slug} className="!w-[300px] md:!w-[400px]">
                <div className="relative h-96 w-full rounded-xl shadow-lg overflow-hidden group">
                  <img src={article.featuredImage} alt={article.title} className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" />
          ...
          <button className="swiper-button-prev-custom-featured featured-swiper-button absolute top-1/2 -translate-y-1/2 left-0 z-10 hidden md:flex">
            <FaArrowLeft />
          </button>
          <button className="swiper-button-next-custom-featured featured-swiper-button absolute top-1/2 -translate-y-1/2 right-0 z-10 hidden md:flex">
            <FaArrowRight />
          </button>
        </div>
      </div>
