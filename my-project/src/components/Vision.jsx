...
const Vision = () => {
  // Abstract background image for a tech feel
  const bgImageUrl = 'https://images.unsplash.com/photo-1550745165-9bc0b252726a?q=80&w=1470';

  return (
    <section name="vision" className="relative py-24 bg-cover bg-fixed px-4" style={{backgroundImage: `url(${bgImageUrl})`}}>
      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          <div className="flex items-start gap-4 bg-white/5 p-4 rounded-lg">
            <FaBullseye className="text-3xl text-[#00A39C] mt-1" />
            <div>
              <h3 className="font-bold text-white text-xl">Our Mission</h3>
              <p className="text-gray-400">To showcase original articles and research from students across all faculties, bridging disciplines and fostering a culture of excellence.</p>
            </div>
          </div>
          <div className="flex items-start gap-4 bg-white/5 p-4 rounded-lg">
            <FaGlobe className="text-3xl text-[#00A39C] mt-1" />
            <div>
              <h3 className="font-bold text-white text-xl">International Standard</h3>
              <p className="text-gray-400">We are committed to maintaining a professional platform that reflects the high standards of IEEE and our global community.</p>
            </div>
          </div>
        </motion.div>
      </div>
